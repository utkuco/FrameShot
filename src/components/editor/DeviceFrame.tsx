...
export function DeviceFrame({ device, children }: DeviceFrameProps) {
  switch (device) {
    case "iphone-15":
      return (
        <div className="relative">
          <div className="bg-black rounded-[3rem] p-3 border-2 border-gray-700 shadow-inner" style={{ width: "320px" }}>
            {/* Dynamic Island */}
            <div className="absolute top-2 left-1/2 -translate-x-1/2 w-28 h-7 bg-black rounded-b-2xl z-10" />
            {/* Screen */}
            <div className="overflow-hidden rounded-[2.2rem] bg-white" style={{ height: "620px" }}>
              {children}
            </div>
            {/* Home indicator */}
    ...
    case "iphone-15-pro":
      return (
        <div className="relative">
          <div className="bg-[#1d1d1f] rounded-[3rem] p-3 border border-gray-600 shadow-inner" style={{ width: "320px" }}>
    ...
    case "pixel-8":
      return (
        <div className="relative">
          <div className="bg-[#1a1a1a] rounded-[2.5rem] p-2.5 border border-gray-700 shadow-inner" style={{ width: "310px" }}>
            {/* Camera cutout */}
            ...
            {/* Screen */}
            <div className="overflow-hidden rounded-[2rem] bg-white" style={{ height: "610px" }}>
              {children}
            </div>
          </div>
        </div>
    ...
    case "ipad-pro":
      return (
        <div className="relative">
          <div className="bg-[#1d1d1f] rounded-[1.5rem] p-3 border border-gray-600 shadow-inner" style={{ width: "520px" }}>
            <div className="overflow-hidden rounded-[0.8rem] bg-white" style={{ height: "680px" }}>
              {children}
            </div>
          </div>
        </div>
    ...
    case "macbook-pro":
      return (
        <div className="flex flex-col items-center">
          {/* Screen housing */}
          <div className="bg-[#1d1d1f] rounded-t-[1rem] p-3 border border-gray-600 border-b-0" style={{ width: "640px" }}>
            <div className="flex items-center justify-center mb-1">
              <div className="w-2 h-2 rounded-full bg-gray-700 ring-1 ring-gray-600" />
            </div>
            <div className="overflow-hidden rounded-[0.3rem] bg-white" style={{ height: "400px" }}>
              {children}
            </div>
          </div>
          {/* Base */}
          <div className="bg-gradient-to-b from-[#3a3a3c] to-[#2a2a2e] rounded-b-lg flex items-center justify-center" style={{ width: "700px", height: "16px" }}>
    ...
    case "browser-chrome":
      return (
        <div className="flex flex-col" style={{ width: "900px" }}>
          ...
          <div className="overflow-hidden rounded-b-xl border border-gray-700 border-t-0 bg-white" style={{ height: "500px" }}>
            {children}
          </div>
        </div>
      );
    case "browser-safari":
      return (
        <div className="flex flex-col" style={{ width: "900px" }}>
          ...
          <div className="overflow-hidden rounded-b-xl border border-gray-300 border-t-0 bg-white" style={{ height: "500px" }}>
            {children}
          </div>
        </div>
      );
    case "browser-firefox":
      return (
        <div className="flex flex-col" style={{ width: "900px" }}>
          ...
          <div className="overflow-hidden rounded-b-xl border border-gray-600 border-t-0 bg-white" style={{ height: "500px" }}>
            {children}
          </div>
        </div>
      );
