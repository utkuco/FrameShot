    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 border-b border-border bg-background/80 backdrop-blur-xl">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 sm:h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-base sm:text-lg font-bold tracking-tight bg-gradient-to-r from-primary to-purple-500 bg-clip-text text-transparent">
              FrameShot
            </span>
          </Link>
          ...
          <Link
            href="/editor"
            className="px-4 sm:px-5 py-2 rounded-lg bg-primary hover:bg-primary/90 text-primary-foreground font-medium text-sm transition-colors"
          >
            Open Editor
          </Link>
        </div>
      ...
      <section className="pt-24 sm:pt-32 pb-16 sm:pb-24 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-border bg-card text-[10px] sm:text-xs font-medium text-muted-foreground mb-6 sm:mb-8">
          ...
          <p className="text-sm sm:text-lg text-muted-foreground max-w-xl mx-auto mb-8 sm:mb-10 leading-relaxed px-2">
          ...
          <div className="flex items-center justify-center gap-4">
            <Link
              href="/editor"
              className="px-6 sm:px-8 py-3 sm:py-3.5 rounded-xl bg-primary hover:bg-primary/90 text-primary-foreground font-semibold transition-colors text-sm sm:text-base"
            >
              Start Beautifying →
            </Link>
          </div>
      ...
      <section className="py-12 sm:py-20 px-4 sm:px-6" id="how-it-works">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10 sm:mb-14">
            ...
            <p className="text-sm sm:text-base text-muted-foreground max-w-md mx-auto">Three simple steps to transform any screenshot.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
            {[
              ...
              <div
                key={item.step}
                className="p-5 sm:p-6 rounded-xl border border-border bg-card hover:border-ring transition-colors text-center"
              >
      ...
      <section className="py-12 sm:py-20 px-4 sm:px-6" id="features">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10 sm:mb-14">
            ...
            <p className="text-sm sm:text-base text-muted-foreground max-w-md mx-auto">Everything you need, nothing you don&apos;t.</p>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            {[
              ...
              <div
                key={f.title}
                className="p-3.5 sm:p-5 rounded-xl border border-border bg-card hover:border-ring transition-colors"
              >
                <span className="inline-block px-1.5 sm:px-2 py-0.5 rounded text-[9px] sm:text-[11px] font-semibold bg-primary/10 text-primary mb-2 sm:mb-3">
                  {f.tag}
                </span>
      ...
      {/* Use Cases */}
      <section className="py-12 sm:py-20 px-4 sm:px-6 border-t border-border" id="use-cases">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10 sm:mb-14">
            <h2 className="text-xl sm:text-3xl font-bold mb-2 sm:mb-3">Where to Use</h2>
            <p className="text-sm sm:text-base text-muted-foreground max-w-md mx-auto">From app launches to technical blogs.</p>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
            {[
              ...
              <div
                key={u.title}
                className="p-3 sm:p-5 rounded-xl border border-border bg-card hover:border-ring transition-colors text-center"
              >
            ...
            {[
              ...
              >
                <summary className="p-4 sm:p-5 font-medium text-xs sm:text-sm list-none flex items-center justify-between cursor-pointer">
                  {faq.q}
                  <span className="text-muted-foreground group-open:rotate-45 transition-transform text-base sm:text-lg leading-none flex-shrink-0 ml-2">
                    +
                  </span>
                </summary>
      ...
      <section className="py-12 sm:py-20 px-4 sm:px-6 border-t border-border">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <Link
            href="/editor"
            className="inline-flex px-6 sm:px-8 py-3 sm:py-3.5 rounded-xl bg-primary hover:bg-primary/90 text-primary-foreground font-semibold transition-colors text-sm sm:text-base"
          >
      ...
      <footer className="border-t border-border py-6 sm:py-8 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
          ...
          <nav className="flex items-center gap-5 sm:gap-6 text-[10px] sm:text-xs text-muted-foreground">
            <a href="/editor" className="hover:text-foreground">Editor</a>
